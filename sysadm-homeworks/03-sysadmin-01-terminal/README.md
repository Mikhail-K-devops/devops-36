...
```markdown
PS Microsoft.PowerShell.Core\FileSystem::\\wsl$\Ubuntu\home\mikhailk\devops-netology\sysadm-homeworks\03-sysadmin-01-terminal> vagrant init
...
```
```markdown
C:\Windows\System32>mklink /D "C:\devops-netology" "\\wsl.localhost\Ubuntu\home\mikhailk\devops-netology"
символическая ссылка создана для C:\devops-netology <<===>> \\wsl.localhost\Ubuntu\home\mikhailk\devops-netology
```
	* Выполнение в этой директории `vagrant up` установит провайдер VirtualBox для Vagrant, скачает необходимый образ и запустит виртуальную машину.

	* `vagrant suspend` выключит виртуальную машину с сохранением ее состояния (т.е., при следующем `vagrant up` будут запущены все процессы внутри, которые работали на момент вызова suspend), `vagrant halt` выключит виртуальную машину штатным образом.

![Vargant Up](img/vagrant_up.png)
...
```markdown
PS C:\devops-netology\sysadm-homeworks\03-sysadmin-01-terminal\Vagrantcfg> vagrant ssh                                                                                                                                                
==> default: This machine used to live in C:/devops-netology/sysadm-homeworks/03-sysadmin-01-terminal/Vagrantcfg but it's now at C:/devops-netology/sysadm-homeworks/03-sysadmin-01-terminal/Vagrantcfg.
 ...
 * Support:        https://ubuntu.com/advantage
  ...
  System information as of Wed 22 Mar 2023 08:56:55 PM UTC

  System load:  0.0                Processes:             147
  Usage of /:   12.3% of 30.34GB   Users logged in:       1
...
Last login: Wed Mar 22 19:30:51 2023
...
```markdown
HISTFILESIZE, line 596

lines which begin with a space character are not saved in the history  list., line 589
A value of ignoredups causes lines matching the previous history entry to not be saved., line 590
A value of ignoreboth is shorthand for ignorespace and ignoredups., line 590
```
...
7. Завершите работу виртуальной машины чтобы не расходовать ресурсы компьютера и/или батарею ноутбука.
